...
public class CommonUtils {
    ...
    /**
     * check field type is text type
     * 
     * @param fType
     * @return
     */
    public static boolean isTextType(Integer fType) {
        String fieldType = String.valueOf(fType);
        return (FieldTypeEnum.FULLTEXT.getCode().equals(fieldType)
            || FieldTypeEnum.TEXT.getCode().equals(fieldType)
            || FieldTypeEnum.TEXTAREA.getCode().equals(fieldType)
            || FieldTypeEnum.FILE.getCode().equals(fieldType)
            || FieldTypeEnum.PHONE.getCode().equals(fieldType)
            || FieldTypeEnum.EMAIL.getCode().equals(fieldType));
    }
    ...
    public static Object getDefaultValue(String fieldName) {
        if (fieldName.startsWith(FieldTypeEnum.NUMBER.getType())) {
            return 0; 
        }
        else if (fieldName.startsWith(FieldTypeEnum.DATE.getType())) {
            return "'1970-01-01'";
        }
        else if (fieldName.startsWith(FieldTypeEnum.DATETIME.getType())) {
            return "'1970-01-01 00:00:00'";
        }
        else if (fieldName.startsWith(FieldTypeEnum.TIME.getType())) {
            return "'00:00:00'";
        }
        else {
            return "''";
    ...
    /**
     * check field type is range type
     * 
     * @param fType
     * @return
     */
    public static boolean isRangeType(Integer fType) {
        String fieldType = String.valueOf(fType);
        return FieldTypeEnum.DATE.getCode().equals(fieldType)
                || FieldTypeEnum.DATETIME.getCode().equals(fieldType);
    }
    /**
