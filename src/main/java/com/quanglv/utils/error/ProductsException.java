...
public class ProductsException extends RuntimeException{
    ...
    public ProductsException(List<Map<String,Object>> errorItems){
        this.attributes.put(ERROR_NAME,errorItems);
    }

    public ProductsException(String message, String item, String errorCode){
        Map<String, Object> errorItems = putError(message, item, errorCode, null);
        this.attributes.put(ERROR_NAME,errorItems);
    }

    public ProductsException(String message, String item, String errorCode, Integer rowId){
